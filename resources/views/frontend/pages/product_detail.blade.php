									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">{{number_format($after_discount,2)}} INR</span><s>{{number_format($product_detail->price,2)}} INR</s> </p>
											...
											<div class="product-buy">
												<form action="{{route('single-add-to-cart')}}" method="POST">
													...
													<div class="add-to-cart mt-4">
														<a title="Add to cart" class="btn" href="{{route('add-to-cart',$product_detail->slug)}}">Add to cart</a>
																...
																<div class="ratting-main">
																	...
																	<div class="single-rating">
																		<div class="rating-author">
																			...
																			<img src="{{asset('storage/photos/1/users/'.$data->user_info['photo'])}}" alt="{{$data->user_info['photo']}}">
																			@else 
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">{{number_format($data->price,2)}} INR</span>
